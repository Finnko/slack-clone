export default {
  translation: {
    ...
    notifications: {
      ...
      loginError: 'Ошибка соединения, не удалось войти в приложение, попробуйте повторить запрос',
      registerError: 'Ошибка соединения, не удалось зарегистироваться, попробуйте повторить запрос',
