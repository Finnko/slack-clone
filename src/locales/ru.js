export default {
  translation: {
    ...
    rollbar: {
      login: 'Ошибка при попытке логина',
      register: 'Ошибка при попытке регистрации',
      data: 'Ошибка при попытке загрузки данных о каналах',
      sendMessage: 'Ошибка отправки сообщения в чат',
    },
    ui: {
      form: {
        loginTitle: 'Войти',
